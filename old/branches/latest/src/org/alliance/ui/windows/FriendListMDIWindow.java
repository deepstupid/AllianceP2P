...
public class FriendListMDIWindow extends AllianceMDIWindow {
    ...
    public FriendListMDIWindow(MDIManager manager, UISubsystem ui) throws Exception {
        ...
        groupIcon = new ImageIcon(ui.getRl().getResource("org.alliance.gfx/icons/editgroup.png"));
        ...
        for (int i = 0; i < LEVEL_ICONS.length; i++) {
            friendIcons[i] = new ImageIcon(ui.getRl().getResource("org.alliance.gfx/icons/" + LEVEL_ICONS[i] + ".png"));
            friendIconsAway[i] = new ImageIcon(ui.getRl().getResource("org.alliance.gfx/icons/" + LEVEL_ICONS[i] + "_away.png"));
        }
        iconFriendDimmed = new ImageIcon(ui.getRl().getResource("org.alliance.gfx/icons/friend_dimmed.png"));
        iconFriendOld = new ImageIcon(ui.getRl().getResource("org.alliance.gfx/icons/friend_old.png"));
    ...
    private String getLevelIcon(int myLevel, boolean big) {
        ...
        return "org.alliance.gfx/icons/" + LEVEL_ICONS[myLevel] + (big ? "_big" : "") + ".png";
    }
