...
public class FriendsTreeMDIWindow extends AllianceMDIWindow {
    ...
    public FriendsTreeMDIWindow(MDIManager manager, UISubsystem ui) throws Exception {
        ...
        iconMe = new ImageIcon(ui.getRl().getResource("org.alliance.gfx/icons/me.png"));
        iconFriend = new ImageIcon(ui.getRl().getResource("org.alliance.gfx/icons/friend.png"));
        iconFriendDimmed = new ImageIcon(ui.getRl().getResource("org.alliance.gfx/icons/friend_dimmed.png"));
        iconNode = new ImageIcon(ui.getRl().getResource("org.alliance.gfx/icons/node.png"));
        iconNodeDimmed = new ImageIcon(ui.getRl().getResource("org.alliance.gfx/icons/node_dimmed.png"));
        iconRecursion = new ImageIcon(ui.getRl().getResource("org.alliance.gfx/icons/recursion.png"));
