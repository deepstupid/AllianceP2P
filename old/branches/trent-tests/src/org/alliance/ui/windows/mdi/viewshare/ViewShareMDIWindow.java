...
public class ViewShareMDIWindow extends AllianceMDIWindow {
    ...
    public ViewShareMDIWindow(final UISubsystem ui, Node remote) throws Exception {
        ...
        iconLoading = new ImageIcon(ui.getRl().getResource("org.alliance.gfx/icons/loadingsharenode.png"));
        iconDown = new ImageIcon(ui.getRl().getResource("org.alliance.gfx/icons/download.png"));
        ...
        for (int i = 0; i < fileTypeIcons.length; i++) {
            fileTypeIcons[i] = new ImageIcon(ui.getRl().getResource("org.alliance.gfx/filetypes/" + i + ".png"));
        }
        folderIconExpanded = new ImageIcon(ui.getRl().getResource("org.alliance.gfx/icons/viewshare.png"));
        folderIconCollapsed = new ImageIcon(ui.getRl().getResource("org.alliance.gfx/icons/folder_closed.png"));
