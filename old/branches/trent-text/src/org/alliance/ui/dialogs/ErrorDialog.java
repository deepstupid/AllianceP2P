...
public class ErrorDialog extends XUIDialog {
    ...
    private void initInCorrectThread(Throwable error, boolean fatal) throws XUIException {
        try {
            ...
            if (!(fatal)) {
                ((JLabel) this.xui.getComponent("image")).setIcon(new ImageIcon(rl.getResource("res/org.alliance.gfx/icons/warning.png")));
    ...
    static {
        try {
            fakeParent.setIconImage(Toolkit.getDefaultToolkit().getImage(rl.getResource("res/org.alliance.gfx/icons/icon.png")));
        } catch (Exception e) {
        }
    }
